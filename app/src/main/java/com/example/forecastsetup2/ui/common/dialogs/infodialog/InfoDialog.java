package com.example.forecastsetup2.ui.common.dialogs.infodialog;
...
import com.example.forecastsetup2.ui.common.dialogs.BaseDialog;
...
public class InfoDialog extends BaseDialog {
    ...
    public final Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mTxtTitle = (TextView) dialog.findViewById(R.id.txt_title);
        mTxtMessage = (TextView) dialog.findViewById(R.id.txt_message);
        mBtnPositive = (AppCompatButton) dialog.findViewById(R.id.btn_positive);
